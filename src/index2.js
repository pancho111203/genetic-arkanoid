...
const demoConfig = [{
    levelNr: 20,
    balls: [[[-34.09, -25.18, 0], [-0.67, 0.74, 0]], [[-24.09, -55.18, 0], [-0.57, 0.74, 0]], [[4.09, -25.18, 0], [-0.67, -101.74, 0]], [[-34.09, -40.18, 0], [-0.67, 0.14, 0]]]
},
{
    levelNr: 20,
    balls: [[[-34.09, -25.18, 0], [-0.67, 0.74, 0]], [[-24.09, -55.18, 0], [-0.57, 0.74, 0]], [[4.09, -25.18, 0], [-0.67, -101.74, 0]], [[-34.09, -40.18, 0], [-0.67, 0.14, 0]]]
...
// TEMP
const renderedSimulation = new Simulation(false, demoConfig, 1/60, 500);
renderedSimulation.onFinished((data) => {
    console.log(data.secondsTaken);
});
